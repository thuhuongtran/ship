...
public class WaitOrderRequest {
    ...
    public WaitOrderRequest(double from_lat, double from_log, double to_lat, double to_log, String client_phone, int item_type, String adv_paym, int mass, String note, String from, String to, double distance, double wait_time) {
